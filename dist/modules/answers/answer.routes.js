 ...
 */
router.post("/questions/:id/answers", authMiddleware("org"), (async (req, res, next) => {
    try {
 ...
 *         description: Unauthorized
 */
router.get("/questions/:id/answers", authMiddleware(), (async (req, res, next) => {
    try {
        const id_question = Number(req.params.id);
 ...
 */
router.put("/answers/:id", authMiddleware("org"), (async (req, res, next) => {
    try {
 ...
 *         description: Answer not found
 */
router.delete("/answers/:id", authMiddleware("org"), (async (req, res, next) => {
    try {
        const id = Number(req.params.id);
